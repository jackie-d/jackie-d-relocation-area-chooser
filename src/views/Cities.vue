  ...
  <div>
    ...
    <mdb-container style="height: 100%">
          <section class="text-center">
            <h2 class="h1 pt-4">{{ $t('cities.title') }}</h2>

            <p class="text-primary mb-5 mt-5 px-3">{{ $t('cities.desc') }}</p>
          </section>
      <mdb-row>
        <mdb-col md="4" class="mt-2">
            <mdb-card style="height: 100%">
              ...
              <mdb-card-body>
                ...
                <mdb-card-text>
                  <p class="text-justify" v-html="$t('common.city_1_desc')"></p>
                </mdb-card-text>
              </mdb-card-body>
            </mdb-card>
        </mdb-col>
        <mdb-col md="4" class="mt-2">
            <mdb-card style="height: 100%">
              ...
              <mdb-card-body>
                ...
                <mdb-card-text>
                  <p class="text-justify" v-html="$t('common.city_2_desc')"></p>
                </mdb-card-text>
              </mdb-card-body>
            </mdb-card>
        </mdb-col>
        <mdb-col md="4" class="mt-2">
            <mdb-card style="height: 100%">
              ...
              <mdb-card-body>
                ...
                <mdb-card-text>
                  <p class="text-justify" v-html="$t('common.city_3_desc')"></p>
                </mdb-card-text>
              </mdb-card-body>
            </mdb-card>
        </mdb-col>
      ...
      <div class="mt-4 pb-4">
        <mdb-btn color="primary" v-on:click="goToNext"><mdb-icon icon="arrow-right" class="mr-1"/> {{ $t('cities.start_selection') }}</mdb-btn>
      </div>
    </mdb-container>
  </div>
</template>
